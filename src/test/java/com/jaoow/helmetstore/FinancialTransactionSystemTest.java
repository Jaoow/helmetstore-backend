...
public class FinancialTransactionSystemTest {
    ...
    public void testTransactionDetailDeductsFromProfit() {
        ...
        // Test that PROFIT_WITHDRAWAL does not affect profit
        assertFalse(TransactionDetail.PROFIT_WITHDRAWAL.deductsFromProfit(), 
            "PROFIT_WITHDRAWAL should not deduct from profit - it's withdrawal");
    ...
    public void testProfitCalculationLogic() {
        ...
        assertTrue(TransactionDetail.PRODUCT_PURCHASE.deductsFromProfit() == false, "PRODUCT_PURCHASE should not affect profit");
        assertTrue(TransactionDetail.ELECTRICITY.deductsFromProfit() == true, "ELECTRICITY should deduct from profit");
        assertTrue(TransactionDetail.OWNER_INVESTMENT.deductsFromProfit() == false, "OWNER_INVESTMENT should not affect profit");
        assertTrue(TransactionDetail.PROFIT_WITHDRAWAL.deductsFromProfit() == false, "PROFIT_WITHDRAWAL should not affect profit");
    }
} 